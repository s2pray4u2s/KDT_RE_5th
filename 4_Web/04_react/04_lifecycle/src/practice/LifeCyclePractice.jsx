...
import LifeCyclePracticeChild from "./LifeCyclePracticeChild";
...
function LifeCyclePractice() {
    ...
    return ( 
        <div className = "LifeCyclePractice">
            <header>📨 Post List</header>
            {posts.length > 0 ? (
                posts.map((post) => {
                    return <LifeCyclePracticeChild key = {post.id} post = {post} />;
                })
            ):(<h2>Loading...</h2>)}
        </div>
     );
